...
public class BasePageObject {
	...
	protected WebDriver driver; // protected variable lets the sub-classes of this object use them as unique instance on creation
	...
	// This method is public because we have to use it in test and not just PageObjects
	 ...
	 * on the page
	 */
	protected void waitForVisibilityOf(By locator, Duration... timeOut) { // The ... means that this parameter is optional. If this parameter is not passed, then by default it will wait for 30 seconds as instantiated above
		int attempts = 0;
		while (attempts < 2) {
			try {
	...
	/** Perform scroll to the bottom using JavaScript Executor*/
	...
	/** Drag 'from' element to 'to' element using JavaScript Executor*/
